define([], function () {
  return {
    ...
    TextGpt41: 'GPT-4.1',
    TextGpt41Mini: 'GPT-4.1 Мини',
    TextGpt41Nano: 'GPT-4.1 Нано',
    TextGpt4Turbo: 'GPT-4 Турбо',
    TextGpt5: 'GPT-5',
    TextGpt5Chat: 'GPT-5 Чат',
    TextGpt5Mini: 'GPT-5 Мини',
    TextGpt5Nano: 'GPT-5 Нано',
    TextO1Mini: 'O1 Мини',
    ...
    TextStop: 'Стоп',
    TextStreamingUnsupported: 'опция потоковой передачи не поддерживается для этой модели',
