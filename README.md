...
Native **OpenAI** is a public service, which provides the optional API by paid subscriptions. Any data provided to endpoints of Native OpenAI goes outside the boundaries of your tenant. As of December 2023, Native OpenAI is <a href="https://openai.com/security" target="_blank">GDPR-compliant</a>.
